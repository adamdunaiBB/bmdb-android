...
public class RecyclerViewAdapter extends RecyclerViewAdapterBase<MovieDataModel, GridItemView> {
    ...
    private GridItemView.OnItemClickedListener onItemClickedListener;

    public RecyclerViewAdapter(List<MovieDataModel> items) {
        super(items);
    }

    public void setOnItemClickedListener(GridItemView.OnItemClickedListener onItemClickedListener) {
